...
type ToolbarButtonProps = { label: string; active?: boolean; disabled?: boolean; onClick: () => void };
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? "bg-chrome-active text-chrome-foreground" : "text-editor-muted hover:bg-editor-hover hover:text-editor-foreground",
    ...
    <div className="flex flex-wrap items-center gap-1">
      ...
      <LinkDialog
        ...
        onSubmit={(url) => {
          ...
          editor.chain().setTextSelection(linkSelection).setLink({ href: url }).run();
