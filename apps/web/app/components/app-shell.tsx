                    ...
                    {documentLoading ? (
                        ...
                        <div className="mx-auto flex w-full max-w-3xl flex-col items-center justify-center px-6 py-16 text-center">
                            ...
                            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
                                ...
                                <a href="https://github.com/signup?source=gitnote" target="_blank" rel="noreferrer" className="rounded-md border border-input bg-background px-4 py-2 text-sm font-medium hover:bg-accent">¿No tienes cuenta? Crear en GitHub</a>
                            </div>
                            <p className="mt-3 text-xs text-muted-foreground">Te lleva a GitHub para iniciar sesión o registrarte, luego vuelve automáticamente.</p>
